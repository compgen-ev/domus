...
import { baseStyles, iconButtonStyles, controlPanelStyles } from '../styles/shared';
import './icon';
import './app-button';
import './historical-layer-picker';
...
export class MapView extends LitElement {
  ...
  render() {
    return html`
      ...
      <div class="floating-controls">
        ...
        <historical-layer-picker
          .map=${this.mapReady ? this.map : undefined}
          insertBeforeLayerId="ohm-buildings-fill"
          @zoom-hint-changed=${this._onHistoricalZoomHintChanged}
        ></historical-layer-picker>
      </div>
  ...
  private _onHistoricalZoomHintChanged(e: CustomEvent<{ visible: boolean }>) {
    this.historicalZoomHintVisible = e.detail.visible;
  }
